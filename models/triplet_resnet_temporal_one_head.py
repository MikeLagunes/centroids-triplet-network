...
__all__ = ['triplet_resnet50_temporal']
...
class Triplet_ResNet_Temporal(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(Triplet_ResNet_Temporal, self).__init__()
    ...
    def forward(self, input1, input2, input3, input1_nby):
        ...
        _, embedding_vec_1_nby = self.forward_sibling(input1_nby)



        return embedding_vec_1, embedding_vec_2, embedding_vec_3, embedding_vec_1_nby, torch.cat((softmax_vec_1, softmax_vec_2, softmax_vec_3), 0)



def triplet_resnet50_temporal(pretrained=False,  num_classes=50, embedding_size=128, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Triplet_ResNet_Temporal(Bottleneck, [3, 4, 6, 3], num_classes=50, **kwargs)
