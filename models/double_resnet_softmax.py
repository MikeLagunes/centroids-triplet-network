...
__all__ = ['double_resnet50_softmax']
...
class Double_ResNet_Softmax(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(Double_ResNet_Softmax, self).__init__()
    ...
    def forward(self, input1, input2):
       ...
       # softmax_vec_3, embedding_vec_3 = self.forward_sibling(input3)
        ...
        return embedding_vec_1, embedding_vec_2, torch.cat((softmax_vec_1, softmax_vec_2), 0)



def double_resnet50_softmax(pretrained=False,  num_classes=50, embedding_size=128, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Double_ResNet_Softmax(Bottleneck, [3, 4, 6, 3], num_classes=50, **kwargs)
