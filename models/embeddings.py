...
def embeddings(pretrained=False,  num_classes=50, ckpt_path=False, embedding_size = 128, **kwargs):
    ...
    try:
        del weights_init["fc_softmax.weight"]
        del weights_init["fc_softmax.bias"]
        del weights_init["fc_extra.weight"]
        del weights_init["fc_extra.bias"]
    except:
        pass 

    #if (weights_init["fc_softmax.weight"]) == True:
