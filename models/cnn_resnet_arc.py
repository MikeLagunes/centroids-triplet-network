...
class cnn_resnet_arc(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(cnn_resnet_arc, self).__init__()
...
def cnn_resnet50_arc(pretrained=False,  num_classes=1000, embedding_size=128, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = cnn_resnet_arc(Bottleneck, [3, 4, 6, 3], num_classes=1000,**kwargs)
