...
__all__ = ['triplet_resnet50_softmax_single']
...
class Triplet_ResNet_Softmax_Single(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(Triplet_ResNet_Softmax_Single, self).__init__()
...
def triplet_resnet50_softmax_single(pretrained=False,  num_classes=50, embedding_size=128, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Triplet_ResNet_Softmax_Single(Bottleneck, [3, 4, 6, 3], num_classes=50, **kwargs)
