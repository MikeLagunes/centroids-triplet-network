...
def KNN_precision():
    ...
    train_file = "/home/alexa/Miguel/best_insitu/train_triplet_exemplar_softmax_household_temp_test_centers_v3_m5_n0.01x1_full.npz"
    test_file  = "/home/alexa/Miguel/best_insitu/test_triplet_exemplar_softmax_household_temp_test_centers_v3_m5_n0.01x1_full.npz"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--instances', nargs='?', type=str, default="full",
                        help='Path of the input image')
    parser.add_argument('--num_classes', nargs='?', type=int, default=20,
